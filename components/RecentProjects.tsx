      ...
      <div className="flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-10">
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          ...
          >
            ...
            <PinContainer title={link}   href="https://github.com/Shalini06singh?tab=repositories"> 
              ...
              <Link href="https://github.com/Shalini06singh?tab=repositories">  {title}</Link> 
              </h1>
              ...
              <div className="flex items-center justify-between mt-7 mb-3">
                ...
                <div className="flex justify-center items-center">
                  <p className="flex lg:text-xl  md:text-xs text-sm text-purple">
                    ...
                    <Link href="https://github.com/Shalini06singh?tab=repositories">  Check Live Site</Link>
                  </p>
